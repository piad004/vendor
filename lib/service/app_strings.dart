...
class AppStrings {
  ...
  static bool get canScheduleTaxiOrder => (env('taxi')['canScheduleTaxiOrder'] == "1" ) ?? false;
  static int get taxiMaxScheduleDays => (env('taxi')['taxiMaxScheduleDays'].toInt() ) ?? 2;
