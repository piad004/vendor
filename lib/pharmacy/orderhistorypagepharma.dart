...
class InsightPagePharma extends StatelessWidget {
  @override
...
class InsightPharma extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return InsightStatePharma();
  }
}

class InsightStatePharma extends State<InsightPharma> {
  ...
  void getTodayOrders() async {
    ...
    var todayOrderUrl = pharmacy_complete_order;
    client
