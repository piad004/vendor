...
var store_stockchange = Uri.parse(baseUrl + "store_stock_update");
var search_product = Uri.parse(baseUrl + "search_product");
var search_medicine_product = Uri.parse(baseUrl + "search-medicine-keywords");
...
var unitList = Uri.parse(baseUrl + "unit_list");
var orderCancel = Uri.parse(baseUrl + "ord_reject_by_vendor");
...
var pharmacy_product_search = Uri.parse(baseUrl + "pharmacy-product-search");
...
dynamic PLAY_STORE_URL =
    'https://play.google.com/store/apps/details?id=delfastvendor.primacyinfotech.com';
