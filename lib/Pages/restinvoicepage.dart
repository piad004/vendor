...
class MyInvoiceRestPdfState extends State<MyInvoiceRestPdf> {
  ...
  bool isLoading = true;
  TodayOrderRestaurant invoiceBeand;
  dynamic apCurrency;
  // dynamic appnamne;
  ...
  void createPdf(TodayOrderRestaurant invoiceBean) async {
              ...
              children: [
                PDF.Container(
                  ...
                  child: PDF.Table.fromTextArray(
                      ...
                      data: <List<String>>[
                        <String>['To'],
                        <String>['${invoiceBeand.user_name}'],
                        <String>['${invoiceBeand.address}'],
                      ],
  ...
  dynamic createDataPdf(List<TodayRestaurantOrderDetails> data) {
